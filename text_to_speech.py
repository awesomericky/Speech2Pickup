...
def text_to_speech_for_model_test(sentence, voice_config, file_path='output.wav'):
...
sentence = 'pick up the block on the top right'
voice_config = {'gender': 'FEMALE', 'accent': 'en-AS'}
